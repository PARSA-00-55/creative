    ...
    <Box sx={{ mb: 8 }}>
      ...
      >
        <CreativeAccordion
          ...
          description="You can pay with a credit card or via net banking (if you're in United States), We will renew your sebscription automatically at the end of every billing cycle."
        />
